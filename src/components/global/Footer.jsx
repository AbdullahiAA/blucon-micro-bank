  ...
  return (
    <footer className='footer'>
        ...
        <div className="footer__services">
            <h5>Services</h5>
            <ul>
                <li><a href="#">Daily Thrift Contribution</a></li>
                <li><a href="#">Bank Account</a></li>
                <li><a href="#">Credit Facilities</a></li>
                <li><a href="#">Equipment Microleasing</a></li>
                <li><a href="#">Farm Input Loan</a></li>
                <li><a href="#">Tricycle Finance</a></li>
            </ul>
        </div>
        ...
        <div className="footer__links">
            ...
            <ul>
                ...
                <li><a href="#">Dowload Our App</a></li>
            </ul>
        </div>
    </footer>
  )
